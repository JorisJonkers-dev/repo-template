#!/usr/bin/env bash
# render-local.sh — local CI-parity render for minimal-service.
#
...
CONTEXT_REF="${CONTEXT_REF:-ghcr.io/jorisjonkers-dev/cluster-deploy-context-public@sha256:1111111111111111111111111111111111111111111111111111111111111111}"
...
write_scorecard_outputs() {
  {
    echo "# Deployment readiness scorecard — minimal-service"
    echo ""
    echo "| Check | Status |"
    echo "|-------|--------|"
